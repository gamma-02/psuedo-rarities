...
public abstract class ItemStackRarityRenderMixin {
    ...
    @Redirect(method = "getTooltip", at = @At(target = "Lnet/minecraft/text/MutableText;formatted(Lnet/minecraft/util/Formatting;)Lnet/minecraft/text/MutableText;", value = "INVOKE", ordinal = 0))
